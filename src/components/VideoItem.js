...
const VideoItem = ({ video, handleVideoSelect, horizontal }) => {

    console.log(horizontal)
    
    return (
        <div className={['video-item', horizontal].join(' ')} onClick={() => handleVideoSelect(video)}>
            ...
            <div className='content video-info'>
                ...
                <div className='video-preview-metadata-container'>
                    ...
                    <div><span>{video.snippet.publishedAt}</span></div>
                </div>
            </div>
        </div>
    )
